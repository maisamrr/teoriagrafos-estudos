...
int main() {
    ...
    //imprimir o grafo = vertices + a lista de adj de cada um deles
    // imprimirGrafo(int qtd_vertices, vertices *v)
    // imprimirLista(vertices[a].lista_adjacencia);
    // imprimirLista(vertices[b].lista_adjacencia);
